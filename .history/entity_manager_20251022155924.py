...
class Game:
    ...
    def level_up_menu(self,player):
        ...
        while True:
            ...
            level_choice = self.get_choices(f"What will you level up? \1", [level_options["1"]["variable"],level_options["2"]["variable"], level_options["3"]["variable"], level_options["4"]["variable"]])
            if level_choice=="0":
                self.live(player)
            elif level_choice:
